...
public struct Word {
	private static let wSegSpace = Group(.wSegSpace)
	private static let hebrewLetter = Group(.hebrewLetter)
	private static let aHLetter = Group(.aLetter) || hebrewLetter
	private static let midLetter = Group(.midLetter)
	private static let midNumLet = Group(.midNumLet)
	private static let singleQuote = Group(.singleQuote)
	private static let doubleQuote = Group(.doubleQuote)
	private static let numeric = Group(.numeric)
	private static let midNum = Group(.midNum)
...
private enum UnicodeProperty: String {
	case singleQuote = "Single_Quote", ZWJ, midNum = "MidNum", aLetter = "ALetter", numeric = "Numeric", newline = "Newline", CR, wSegSpace = "WSegSpace", hebrewLetter = "Hebrew_Letter", extend = "Extend", doubleQuote = "Double_Quote", format = "Format", extendNumLet = "ExtendNumLet", midLetter = "MidLetter", katakana = "Katakana", LF, midNumLet = "MidNumLet", regionalIndicator = "Regional_Indicator"
}

private let propertyRanges: [UnicodeProperty: ContiguousArray<ClosedRange<UInt32>>] = [
	.singleQuote: [39 ... 39],
	.ZWJ: [8205 ... 8205],
	...
	.doubleQuote: [34 ... 34],
	.format: [173 ... 173, 1536 ... 1541, 1564 ... 1564, 1757 ... 1757, 1807 ... 1807, 2274 ... 2274, 6158 ... 6158, 8206 ... 8207, 8234 ... 8238, 8288 ... 8292, 8294 ... 8303, 65279 ... 65279, 65529 ... 65531, 69821 ... 69821, 69837 ... 69837, 78896 ... 78904, 113_824 ... 113_827, 119_155 ... 119_162, 917_505 ... 917_505],
	.extendNumLet: [95 ... 95, 8239 ... 8239, 8255 ... 8256, 8276 ... 8276, 65075 ... 65076, 65101 ... 65103, 65343 ... 65343],
	.midLetter: [58 ... 58, 183 ... 183, 903 ... 903, 1524 ... 1524, 8231 ... 8231, 65043 ... 65043, 65109 ... 65109, 65306 ... 65306],
	.katakana: [12337 ... 12341, 12443 ... 12444, 12448 ... 12538, 12540 ... 12543, 12784 ... 12799, 13008 ... 13054, 13056 ... 13143, 65382 ... 65437, 110_592 ... 110_592, 110_948 ... 110_951],
	.LF: [10 ... 10],
	.midNumLet: [46 ... 46, 8216 ... 8217, 8228 ... 8228, 65106 ... 65106, 65287 ... 65287, 65294 ... 65294],
	.regionalIndicator: [127_462 ... 127_487],
]
